        ...
        <Flex w="100%" py="20px" flexDirection="column">
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Jumlah Anggota</b>: 3-5 Mahasiswa
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Lap. Kemajuan, Lap. Akhir, Artikel Ilmiah, dan/atau Produk Program
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: LEACHING (H2SO4 DAN H2O2) DAN EKSTRAKSI LIMBAH BATERAI LI-ION UNTUK RECOVERY NIKEL
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Lap. Kemajuan, Lap. Akhir, dan/atau Produk Program
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: Cleft Sintesa_ Teknologi Sintesis Wajah 3D untuk Membantu Penanganan Pasien Bibir Sumbing di CCC (Cleft and Craniofacial Center)
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Lap. Kemajuan, Lap Akhir, Prototipe atau Produk Fungsional
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: LESTARI.IN : APLIKASI URUN DANA PELESTARIAN HUTAN MELALUI PENYIRAMAN RTH BERBASIS IOT
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: PROGRAM SEHATI SEBAGAI UPAYA PENCEGAHAN ANEMIA PADA REMAJA PUTRI
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Artikel Ilmiah memuat konsep perubahan atau pengembangan
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    padding="12px 0"
                    >
                        <b>Pendanaan</b>: Intensif Rp3 Juta
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: GENOM.ID : BASIS DATA GENETIK NASIONAL SEBAGAI REFERENSI PROFIL DNA INDONESIA
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Lap. Kemajuan, Lap. Akhir, Video yang diunggah ke YOUTUBE
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: INOVASI TEKNOLOGI PENANGGULANGAN BENCANA BERBASIS ENERGI SURYA DAN FILTRASI AIR PORTABEL
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Artikel Ilmiah
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    padding="12px 0"
                    >
                        <b>Pendanaan</b>: Intesif Rp3 Juta
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>: IMPLEMENTASI ARTIFICIAL NEURAL NETWORK DALAM MEMPREDIKSI HARGA SAHAM
                    </Text>
                </Box>
            </Flex>
            ...
            >
                ...
                margin="0 auto">
                    ...
                    padding="12px 0"
                    >
                        <b>Luaran yang diharapkan</b>: Lap. Kemajuan, Lap. Akhir, Produk Usaha
                    </Text>
                    <Text
                    fontSize= "24px"
                    lineHeight= "28px"
                    ...
                    padding="12px 0"
                    >
                        <b>Contoh Judul Proposal</b>:  KREASI KAIN BATIK BERMOTIFKAN SPESIES-SPESIES ALGA INDONESIA
                    </Text>
                </Box>
            </Flex>
