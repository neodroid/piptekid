...
const TimeMenu = (props)=> (
    <Flex  bg="white" mt="20" mb="20"  align="center" justify="center" flexDirection={props.direc}><Box w="wrap" bg="" ><img width="100px" src={props.img}/> </Box>
    <Box
   
   as="h1" fontSize="xl" letterSpacing={".1rem"}   fontFamily="heading" fontWeight="bold"
    color="#254D69" bg="white"
>{props.judul}
<Text 
